...
# Modelo en partes
i_th <- (p+1):(n-p-1)
md_th <- vr_mSth(Datax1, Datay1, p, i_th)
...
y_th <- s_mSt(ai_sel, as_sel, x_th, Datax1)

plot(Datax1, Datay1, col = "red", pch = 19)
lines(Datax1, y_sel, col = "blue", type = "l", lwd = 4)
lines(Datax1, y_th, col = "green", type = "l", lwd = 4)
grid()